export function Header() {
    return (
        <header className="fixed w-full bg-[#0a0a0ac9] backdrop-blur-md flex items-center py-6 md:px-16 px-6 border-b border-zinc-800 z-50 ">
            <div className="max-w-6xl mx-auto w-full flex justify-between ">
                ...
                <ul className="flex gap-2 ">
                    <li className=" hover:cursor-pointer hover-scale">
