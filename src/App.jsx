      ...
      <main className='mx-auto w-[95%] h-screen flex flex-col justify-between  lg:flex-row 2xl:w-full  2xl:max-w-6xl mx-auto'>
        <div className='w-full mt-30  flex items-center flex-col justify-center lg:w-[50%]'>
          ...
          <div className='w-full flex flex-wrap justify-start items-center gap-5 mt-5 lg:ml-2'>
            ...
            <a href='./src/assets/Curriculo_Thiago_Oliveira.pdf' download='Curriculo_Thiago_Oliveira.pdf' className=' flex  flex justify-center items-center gap-2 border-1 border-[#1C243A] dark:border-1 dark:border-[white] dark:text-[white] dark:hover:text-[#ccc] p-2 rounded-md hover:cursor-pointer hover-scale' target="_blank">
